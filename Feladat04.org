...
végrehajtásához egy /DJI Mavic 3E UAV/-t választottam.
...
A [[fig:DJIMavic3Eoutline]]. ábrán látható DJI Mavic 3E UAV
...
#+CAPTION[DJI Mavic 3E]: DJI Mavic 3E UAV körvonalrajza
#+NAME:   fig:DJIMavic3Eoutline
[[file:DJIMavic3Eoutlinemod.pdf]]
...
MP-es zoom kamera található (lásd a [[fig:DJIMavic3Eoutline]]. ábrát),
...
Ha kihasználjuk a DJI Mavic 3E képességeit a képeket 0.7 másodpercenként készíthetjük,
